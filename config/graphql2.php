<?php
//
//use App\GraphQL\Queries\Fxs\FxsAdvertPaginatorQuery;
//use App\Http\Controllers\GraphqlController;
//
//$defaultSchemasInfo = require(base_path('graphql/default-schemas.php'));
//
//$defaultSchemas = ['query' => [], 'mutation' => []];
//
//foreach ($defaultSchemasInfo as $name => $class) {
//    if (ends_with($class, 'Query')) {
//        $defaultSchemas['query'][$name] = $class;
//    } elseif (ends_with($class, 'Mutation')) {
//        $defaultSchemas['mutation'][$name] = $class;
//    } else {
//        throw new Exception('Graphql 定义有异常'.$name.':'.$class);
//    }
//}
//
//return [
...
//        'middleware' => [\App\Http\Middleware\ForbiddenProductionMiddleware::class],
...
//
//    /*
//     * The defaultSchemas for query and/or mutation. It expects an array to provide
...
//        'fxs'     => [
//            'query' => [
//                'ccc' => FxsAdvertPaginatorQuery::class,
//            ],
//        ],
//    ],
//
...
//     * ]
//     */
//    'types'                 => require(base_path('graphql/types.php')),
//
//    /*
...
//     * ]
//     */
//    'error_formatter'       => [App\Extensions\GraphQL::class, 'formatError'],
//
//    /*
